...
//+kubebuilder:rbac:groups=homer.rajsingh.info,resources=items,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=homer.rajsingh.info,resources=items/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=homer.rajsingh.info,resources=items/finalizers,verbs=update
